...
Quizas uno de los metodos que se podria usar seria la implementacion de un modelo K-means para clusterizar el maximo de palabras posibles de forma dinàmica. 
